...
<div class="container-fluid">
  <div class="row justify-content-center align-items-center">
    ...
    <div class="col-12 col-md-6 d-flex justify-content-center mt-3">
      <div class="card">
        <img class="img-fluid mb-2" src="/img/sfondo2.jpg" alt="card">
        <div class="card__content">
          <p class="card__title pp">Lorem, ipsum.</p>
          <p class="card__description pp text-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
        </div>
      </div>
...
<div class="container-fluid mt-4">
  <div class="row justify-content-center align-items-center">
    ...
    <div class="col-12 col-md-6 d-flex justify-content-center mt-3">
      <div class="card">
        <img class="img-fluid mb-2" src="/img/sfondo.jpg" alt="card">
        <div class="card__content">
          <p class="card__title pp h-3">Lorem, ipsum.</p>
          <p class="card__description pp text-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
        </div>
      </div>
    </div>
...
<div class="container-fluid mt-5">
  <div class="row">
    <div class="col-12 col-md-12 mx-auto">
      <p class="pp p-1">I nostri profili social</p>
